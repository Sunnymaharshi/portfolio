...
export default function Room(props) {
  const { nodes, materials } = useGLTF("/portfolio/models/optimized-room.glb");
  const screensRef = useRef();
  const matcapTexture = useTexture("/portfolio/images/textures/mat1.png");
...
useGLTF.preload("/portfolio/models/optimized-room.glb");
